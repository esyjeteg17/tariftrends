<template>
  <div>
    <div
      class="fixed w-full flex justify-center items-center top-16 left-0 -z-10 overflow-hidden"
    >
      <div
      ...
      <div class="w-10/12 mx-auto flex flex-wrap items-center gap-x-4 gap-y-2">
        <p class="text-sm leading-6 text-gray-900">
          ...
          > -->Чтобы пользоваться всеми функциями, войдите в аккаунт
        </p>
        <nuxt-link to="/login">
          <div
